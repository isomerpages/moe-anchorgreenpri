...
permalink: /useful-links/resources-for-parents/canteen-menu/stall-no-7-malay-noodles-stall/
description: ""
variant: markdown
---
...
<table style="border-collapse: collapse; width: 100%; font-family: 'Prompt', sans-serif; font-size: 16px; text-align: center;">
  ...
  <tbody>
    <tr>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">A</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Fried Maggie</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Fried Maggie</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Fried Maggie</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Fried Maggie</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Fried Maggie</td>
    ...
    <tr>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">C</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Fried Macaroni</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Mee Goreng</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Stir-Fried White Bee Hoon</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Fried White Bee Hoon</td>
      <td style="border: 1px solid #2a2a2a; padding: 8px;">Fried Laksa</td>
    </tr>
  </tbody>
</table>