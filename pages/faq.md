...
<pre class="tab2">Covers 65% of school bus fares per year if your child takes the school bus.</pre>
<pre class="tab2">$17 transport credit per month, or up to $204 per year, if your child takes public transport.</pre>
